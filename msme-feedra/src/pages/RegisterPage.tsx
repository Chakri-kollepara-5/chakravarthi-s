...
import { Mail, Lock, User, Eye, EyeOff, Leaf, Building, Heart } from 'lucide-react';
    ...
    try {
      ...
      try {
        ...
        if (emailSent) {
          ...
          toast('Welcome email failed to send. Please check console for details.', { icon: '⚠️' });
        }
      } catch (emailError) {
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-green-600 hover:to-emerald-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
          >
            {loading ? (
        ...
        <div className="mt-4 p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
          <div className="flex items-center justify-center space-x-2">
            ...
            <div className="text-center">
              <div className="text-xs font-semibold text-green-900">Verified by Government of India</div>
